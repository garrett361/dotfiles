...
This skill runs non-interactively (under Claude Code, typically via `claude -p`). Never ask questions, request confirmation, or wait for user input. Analyze the diff, write the message, commit, and report the result.
